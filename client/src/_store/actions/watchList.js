    ...
    axios
      ...
      .then((res) => {
        if (res.data.Data[sym]) {
          ...
          axios
            .put(
              //adding coin to users/watchlist mongodb
            ...
            .catch((err) => {
              ...
              dispatch(
                coinError("error in putting to watchlist in addcoin method")
              );
            });
        } else {
  ...
  return function (dispatch) {
    axios
      ...
      .catch((err) => {
        console.log(err);
        dispatch(
          coinError("There was an error putting from watchlist/delcoin")
        );
      });
  };
};
